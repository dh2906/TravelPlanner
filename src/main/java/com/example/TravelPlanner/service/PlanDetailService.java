...
public class PlanDetailService {
    ...
    public PlanDetailResponse updateDetail(
        ...
        validatePlanRelation(plan, planDetail);
    ...
    public List<PlanDetailResponse> updateDetails(
        ...
        for (PlanDetailBulkUpdateRequest req : request) {
            PlanDetail planDetail = findPlanDetailOrThrow(req.detailId());

            validatePlanRelation(plan, planDetail);

            planDetail.updateInfo(req);
            response.add(PlanDetailResponse.fromEntity(planDetail));
        }
